...
def extract_frame_landmarks(frame, palm_detector, hand_detector, person_detector, pose_detector, prev_landmarks=None, miss_counts=None, max_misses=5):
...
def main():
    ...
    while cap.isOpened():
        ...
        landmarks, miss_counts = extract_frame_landmarks(frame, palm_detector, hand_detector, person_detector, pose_detector, prev_landmarks, miss_counts)
